<%@ Page Title="Povpraševanja" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InquiryTable.aspx.cs" Inherits="GrafolitPDO.Pages.Inquiry.InquiryTable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentHolder" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var NotSendPDFAndEmailsToSupplier = GetUrlQueryStrings()['NotSendPDFAndEmailsToSupplier'];

            if (NotSendPDFAndEmailsToSupplier == '1') {
                ShowModal("Odlično!", "Uspešno ste zaključili povpraševanje!");
                ...
                ShowModal("Odlično!", "Uspešno ste poslali povpraševanje v nabavo!");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <dx:ASPxGridView ID="ASPxGridViewInquiry" runat="server" EnableCallbackCompression="true" ClientInstanceName="gridInquiry"
        OnDataBinding="ASPxGridViewInquiry_DataBinding" Width="100%"
        KeyFieldName="PovprasevanjeID" CssClass="gridview-no-header-padding" OnCustomCallback="ASPxGridViewInquiry_CustomCallback"
        OnCommandButtonInitialize="ASPxGridViewInquiry_CommandButtonInitialize"
        OnHtmlRowPrepared="ASPxGridViewInquiry_HtmlRowPrepared">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="ID" FieldName="PovprasevanjeID" Visible="false" SortOrder="Descending" />
            ...
            <dx:GridViewDataDateColumn Caption="Datum oddaje" FieldName="DatumOddajePovprasevanja" Width="15%" PropertiesDateEdit-DisplayFormatString="dd. MMMM yyyy HH:mm" />
            ...
            <dx:GridViewDataTextColumn Caption="Ustvaril" FieldName="PovprasevanjeOddal.Priimek" Width="10%" />

            <dx:GridViewDataTextColumn Caption="Naročila" FieldName="Narocila" Width="10%" />
    ...
    <div class="AddEditButtonsWrap medium-margin-l medium-margin-r">
        <div class="DeleteButtonElements">
            <dx:ASPxButton ID="btnCopyPos" runat="server" Text="Kopiraj" AutoPostBack="false"
                Height="25" Width="110" ClientInstanceName="clientBtnCopy" UseSubmitBehavior="false" OnClick="btnCopyInqury_Click">
                <Paddings PaddingLeft="10" PaddingRight="10" />
                <Image Url="../../Images/copy.png" UrlHottracked="../../Images/copyHover.png" />
            </dx:ASPxButton>

            <span class="AddEditButtons">
                <dx:ASPxButton ID="btnDelete" runat="server" Text="Izbriši povpraševanje" AutoPostBack="false" OnClick="btnDelete_Click"
                    Height="25" Width="50">
                    <Paddings PaddingLeft="10" PaddingRight="10" />
    ...
    <div class="AddEditButtonsElements">
        ...
        <span class="AddEditButtons">
            <dx:ASPxButton ID="btnAdd" runat="server" Text="Novo" AutoPostBack="false" OnClick="btnAdd_Click"
                Height="25" Width="90">
                <Paddings PaddingLeft="10" PaddingRight="10" />
