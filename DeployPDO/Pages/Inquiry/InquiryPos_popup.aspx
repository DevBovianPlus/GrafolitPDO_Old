<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="InquiryPos_popup.aspx.cs" Inherits="GrafolitPDO.Pages.Inquiry.InquiryPos_popup" %>
                ...
                case 'Potrdi':
                    switch (sender) {
                        case 'SupplierSearch':
                            ...
                            btnSearch.SetEnabled(true);
                            txtSupplierName.SetText(seleSupVal);
                            txtSupplierSearch.Focus();
                            CallbackPanel.PerformCallback("RefreshContactPersons");
                            break;

                        case 'ContactPerson':
                            PopupControlAddContactPerson.Hide();
                            CallbackPanel.PerformCallback("RefreshContactPersons");
                            break;
                    }
                    break;
            ...
            <dx:PanelContent>
                ...
                <div class="row m-0 pb-3">
                    <div class="col-lg-6 mb-2 mb-lg-0">
                        <div class="row m-0 align-items-center">
                            ...
                            <div class="col-6 mr-3 p-0">
                             ...
                             <div class="col-3 p-0">
                                <dx:ASPxButton ID="ASPxButton3" runat="server" AutoPostBack="false" ClientInstanceName="btnAddContact"
                    ...
                    <div class="col-lg-6 mb-2 mb-lg-0">
                        <div class="row m-0 align-items-center">
                            <div class="col-0 p-0" style="margin-right: 15px;">
                                <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="OBVEŠČENE OSEBE :" Font-Size="12px"></dx:ASPxLabel>
                            </div>
                            <div class="col-6 mr-3 p-0">
                                <dx:ASPxGridLookup ID="GridLookupObvesceneOsebe" runat="server" ClientInstanceName="lookUpObvesceneOsebe"
                                    KeyFieldName="idKontaktneOsebe" TextFormatString="{0}" CssClass="text-box-input" SelectionMode="Multiple"
                                    Paddings-PaddingTop="0" Paddings-PaddingBottom="0" Width="100%" Font-Size="13px"
                                    OnLoad="ASPxGridLookupLoad_WidthLarge" OnDataBinding="GridLookupObvesceneOsebe_DataBinding"
                                    IncrementalFilteringMode="Contains">
                                    <ClientSideEvents Init="SetFocus" />
                                    <ClearButton DisplayMode="OnHover" />
                                    <FocusedStyle CssClass="focus-text-box-input"></FocusedStyle>
                                    ...
                                    <Columns>
                                        <dx:GridViewCommandColumn ShowSelectCheckbox="True" />
                                        <dx:GridViewDataTextColumn Caption="Naziv" FieldName="NazivKontaktneOsebe" Width="40%"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Email" FieldName="Email" Width="50%"></dx:GridViewDataTextColumn>
                    ...
                    <div class="col-lg-4 mb-lg-0 ">
                        <div class="row m-0 align-items-center">
                            ...
                            <div class="col-12 p-0">
                                <dx:ASPxHtmlEditor ID="HtmlBodyEmail" runat="server" Width="100%" ToolbarMode="Menu">
